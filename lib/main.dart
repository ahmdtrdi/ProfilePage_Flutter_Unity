...
class _HomePageState extends State<HomePage> {
            ...
            Row(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Text('Manado, Sulawesi Utara',
                        style: TextStyle(
                            fontSize: 15,
  ...
  Widget buildCoverImage() => Container(
      color: Colors.grey,
      child: Image.network(
        'https://64.media.tumblr.com/04bc8d1178bc6109a8e668548f7e1e13/tumblr_mssqxzgbsz1so3m12o1_500.gif',
          ...
          child: Container(
            child: CircleAvatar(
              ...
              backgroundImage: NetworkImage(
                  'https://pbs.twimg.com/media/FxS4uU_aAAAUyVX?format=jpg&name=4096x4096'),
            ),
          ),
        ),
      );
